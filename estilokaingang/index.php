...
<div id="top" class="sg-header sg-container">
  <h1 class="sg-logo">GUIA DE ESTILO <span>TEMA KAINGANG</span></h1>
...
<div class="sg-body sg-container">
  <div class="sg-info">               
    <div class="sg-about sg-section">
      ...
      <p>Documentação de estilos do Tema Kaingang para festivais.</p>
    </div><!--/.sg-about-->
    
    <div class="sg-colors sg-section">
      <h2 class="sg-h2"><a id="sg-colors" class="sg-anchor">Cores defalt</a></h2>
        <div class="sg-color sg-color--a"><span class="sg-color-swatch"><span class="sg-animated">fundo #959595</span></span></div>
        <div class="sg-color sg-color--b"><span class="sg-color-swatch"><span class="sg-animated">detalhes #ececec</span></span></div>
        <div class="sg-color sg-color--c"><span class="sg-color-swatch"><span class="sg-animated">links #cc0033</span></span></div>
        <div class="sg-color sg-color--d"><span class="sg-color-swatch"><span class="sg-animated">backgrounds #fff</span></span></div>
        <div class="sg-color sg-color--e"><span class="sg-color-swatch"><span class="sg-animated">texto #000000</span></span></div>
        <div class="sg-markup-controls"><a class="sg-btn--top" href="#top">Back to Top</a></div>
    </div><!--/.sg-colors-->
    
    <div class="sg-font-stacks sg-section">
      <h2 class="sg-h2"><a id="sg-fontStacks" class="sg-anchor">Fontes</a></h2>
      <p class="sg-font sg-font-primary">Menu: "Titillium Web", sans-serif;</p>
      <p class="sg-font sg-font-secondary">Geral: "Source Sans Pro", sans-serif;</p>
      <div class="sg-markup-controls"><a class="sg-btn--top" href="#top">Back to Top</a></div>
    </div><!--/.sg-font-stacks-->
  </div><!--/.sg-info-->    
